// TODO: Read16, Write16 and WrappingRead16 are only used by the CPU, formalize that
// removing them from here and putting them on the cpu only (CPU shouldnt implement Memory)
