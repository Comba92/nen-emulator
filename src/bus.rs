...
#[derive(Debug)]
enum BusDst { Ram, Ppu, Apu, SRam, Prg, Joypad1, Joypad2, NoImpl, }
...
// TODO: consider moving CHR here, and Mirroring to mapper
// TODO: disable VRAM and OAM during rendering?
...
impl Memory for Bus {
    fn read(&mut self, addr: u16) -> u8 {
        ...
        match dst {
            ...
            _ => {
                debug!("Read to {addr:04X} not implemented");
                0
            }
        }
    }
    ...
    fn poll_irq(&mut self) -> bool {
        self.mapper.borrow_mut().poll_irq() || self.apu.frame_irq_requested.take().is_some()
    }
