...
fn get_instr_first_name<D>(deserializer: D) -> Result<&'static str, D::Error>
where
...
fn get_instr_len(inst: &Instruction) -> usize {
    ...
    match mode {
        ...
        ZeroPage | ZeroPageX | ZeroPageY | IndirectX | IndirectY | Immediate | Relative => 2,
...
pub const RMW_INSTRS: [&'static str; 18] = [
    "ASL", "LSR", "ROL", "ROR", "INC", "DEC", "SLO", "SRE", "RLA", "RRA", "ISB", "DCP", "STA",
    "STX", "STY", "SHA", "SHX", "SHY",
];
